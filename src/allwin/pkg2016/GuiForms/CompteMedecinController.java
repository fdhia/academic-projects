 ...
 * @author Mahmoud
 */
public class CompteMedecinController extends AnchorPane implements Initializable {
    ...
    public void setApp(Main apllication) {
        this.application = apllication;
    }

    @FXML
    public void clickCompteRendu() {
        try {
            rootPane = (AnchorPane) FXMLLoader.load(getClass().getResource("CompteRendu.fxml"));
            PaneDrawer.setContent(rootPane);
            PaneDrawer.setDefaultDrawerSize(0);
    ...
    @FXML
    private void clickInvitation(ActionEvent event) {
    }
